{strip}
    <div style="width: 270px;">
        <link rel="stylesheet" href="layouts/vlayout/modules/Settings/OS2TimeTracker/css/bootstrap-datetimepicker.min.css" type="text/css" media="screen" />
        
        <script type="text/javascript" src="layouts/vlayout/modules/Settings/OS2TimeTracker/resources/bootstrap-datetimepicker.min.js"></script>
        ...
        <div class="modelContainer" >
                ...
                <div class="quickCreateContent">
                    <div class="modal-body">
                        <table style="margin: 0 auto;">
                            ...
                            <tr>
                                <td class="fieldValue medium" colspan="2">
                                    ...
                                    {if $FIELDNAME eq 'subject'}
                                        <div class="row-fluid">
                                            <span class="span10">
                                                <input id="{$FIELDNAME}" type="text" style="width: 210px;" class="fieldInput propFieldInput" name="form_data[{$FIELDNAME}]" value="{if $FORM_DATA[$FIELDNAME] neq ''}
                                                            {$FORM_DATA[$FIELDNAME]}
                                    ...
                                    {elseif $FIELDNAME eq 'description'}
                                        <div class="row-fluid">
                                            <span class="span10">
                                                <textarea id="{$FIELDNAME}" name="form_data[{$FIELDNAME}]" placeholder="{$FIELD_MODEL->get('label')}" style="width: 220px;" class="fieldInput propFieldInput" rows="10">
                                    ...
                                    {elseif $FIELDNAME eq 'activitytype'}
                                        ...
                                        <div class="row-fluid">
                                            <span class="span10">
                                                <select id="{$FIELDNAME}" data-default-value = "{decode_html($SETTING_FIELD[$FIELDNAME]['default'])}" class="chzn-select propSelectFieldInput" name="form_data[{$FIELDNAME}]" style="width: 210px;">
                            ...
                            <tr>
                                <td class="fieldValue medium" colspan="2"><input type="text" style="width: 210px;" id="startDateTime" class="dateTimeField" name="form_data[startdate]"
                                 value="{if $FORM_DATA['startdate']}{$FORM_DATA['startdate']}
                                 {elseif $RECORD_RUNNING['form_data']['startdate']}{$RECORD_RUNNING['form_data']['startdate']}{/if}" placeholder="{if $FORM_DATA['startdate']}{$FORM_DATA['startdate']}{/if}" {if $START_DATETIME_EDITABLE eq 0}readonly{/if} /></td>
                            </tr>
                            <tr>
                                <td class="fieldValue medium" colspan="2"><input type="text" style="width: 210px;" id="endDateTime" class="dateTimeField" name="form_data[enddate]" value="{if $FORM_DATA['enddate']}{$FORM_DATA['enddate']}
                                 {elseif $RECORD_RUNNING['form_data']['enddate']}{$RECORD_RUNNING['form_data']['enddate']}{/if}" placeholder="{if $FORM_DATA['enddate']}{$FORM_DATA['enddate']}{/if}" {if $DUE_DATETIME_EDITABLE eq 0}readonly{/if}/></td>
                            </tr>
                            <tr>
                            </tr>
            ...
            {************LIST TIMER ACTIVE************}
            {if $ACTIVE_TIMER}
                <div class="modal-header contentsBackground" style="text-align: center; border-bottom: none; "><h3 style="color: #004123;">{'ACTIVE_TIMERS'}</h3></div>
