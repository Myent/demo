	...
	*/
	...
	registerEmailFieldClickEvent : function(){
		...
		listViewContentDiv.on('click','.emailField',function(e){
			...
			var res = hr.replace("mailto:", "");
			var mailid = jQuery(this).closest("tr").attr("data-id");
			window.open('index.php?module=OSSMail&view=index&sourceRecord='+mailid+'&sourceModule='+module_name+'&mailAddress='+res);
			return false;
			e.stopPropagation();
		})
	},
