...
{strip}
    ...
    <table class="table table-bordered blockContainer lineItemTable" id="lineItemTab">
        <tr>
            ...
            {if $ALLOW_BILL_EVENT_INVOICE neq 0}<a id="openListEvent" href="javascript:void(0)" class="btn" style="float: right; margin: 7px; background-color: rgb(21, 96, 189); color: rgb(255, 255, 255); text-shadow: none;">{'Review Time Logs'}</a>{/if}</th>
    ...
    <!-- Ganesh added on 01 Sep 2018 -->
<div class="modal" id="timetrackermodal" style="display:none;left: 30%;width: 75%;">
    <div class="modelContainer">
    <div class="modal-header contentsBackground">
        <button class="close" aria-hidden="true" data-dismiss="modal" type="button" title="Close">x</button>
        <h3>Review Time Logs</h3>
    </div>
    <form class="form-horizontal recordEditView" id="frmEventsList" method="post" action="index.php">
            ...
            <div class="modal-body">
                <table class="table table-bordered listViewEntriesTable">
                    ...
                    <tr class="listViewHeaders">
                        ...
                        <th class="medium">Related To</th>
                        <th class="medium">Subject</th>
                        <th class="medium" width="15%">Description</th>
                        <th class="medium">Start Date &amp; Time</th>
                        <th class="medium">Due Date &amp; Time</th>
                        <th class="medium">Duration</th>
                    </tr>
                    </thead>
                        <tbody id="resulttimetrack">
        ...
        <div class="modal-footer quickCreateActions">
            ...
            <button class="btn btn-success" id="btnSaveEvent" type="button"><strong>Add to Invoice</strong></button>
        </div>
    </form>
</div>
</div>
