			...
			<div class="listViewActionsDiv row-fluid">
				<span class="btn-toolbar span4">
					...
					<span class="btn-group">
						<button id="AddPos" class="btn addButton" onclick='window.location.href="index.php?module=OS2PointSale&view=DashBoard"'><i class="icon-plus"></i>&nbsp;<strong>Create Counter Sale</strong></button>
					</span>
				</span>
			<span class="btn-toolbar span4">
