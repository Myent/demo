		...
		{foreach item=LISTVIEW_ENTRY from=$LISTVIEW_ENTRIES}
			...
			<td width="1%" nowrap class="{$WIDTHTYPE}">
				...
				<td nowrap class="{$WIDTHTYPE}">
					{if $LISTVIEW_ENTRY->get('recordid')  neq 0 && $LISTVIEW_ENTRY->get('recordid') neq ''}
					<a onclick="forensicDetailView({$LISTVIEW_ENTRY->get('id')})" {if $EYE[$LISTVIEW_ENTRY->get('id')] eq 'allow'} class="icon-eye-open alignMiddle" {/if}></i></a>&nbsp;
