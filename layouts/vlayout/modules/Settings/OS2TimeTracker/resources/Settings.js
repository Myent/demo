...
jQuery.Class("OS2TimeTracker_Settings_Js",{
    instance:false,
    getInstance: function(){
        if(OS2TimeTracker_Settings_Js.instance == false){
            var instance = new OS2TimeTracker_Settings_Js();
            OS2TimeTracker_Settings_Js.instance = instance;
            return instance;
        }
        return OS2TimeTracker_Settings_Js.instance;
    }
},{
