            ...
            <div class="tab-content massEditContent">
                ...
                <div class="tab-pane" id="module_LBL_TIME_TRACKING_SETTINGS">
                    <div class="widgetContainer" style="padding: 20px 5px 5px 20px;">
                        <div class="row-fluid">
                            ...
                            <input type="checkbox" value="1" {if $START_DATETIME_EDITABLE eq 1}checked="checked"{/if} name="start_datetime_editable"/>
                        </div>
                        <div class="row-fluid">
                            <span class="span2">
                                {'Due Date Time Editable'}
                            </span>
                            <input type="checkbox" value="1" {if $DUE_DATETIME_EDITABLE eq 1}checked="checked"{/if} name="due_datetime_editable"/>
                        </div>
                    </div>
                </div>
                <div class="tab-pane" id="module_LBL_COMMENTS">
                    <div class="widgetContainer" style="padding: 20px 5px 5px 20px;">
                        <div class="row-fluid">
                            <span class="span2">
                                {'Allow to create comments?'}
                            </span>
                            <input type="checkbox" value="1" {if $ALLOW_CREATE_COMMENTS eq 1}checked="checked"{/if} name="allow_create_comments">
                        </div>
                        <div class="row-fluid">
                            <span class="span2">
                                {'Automatically create comments'}
                            </span>
                            <input type="checkbox" value="1" {if $AUTO_CREATE_COMMENTS eq 1}checked="checked"{/if} name="auto_create_comments">
                        </div>
                    </div>
                </div>
                <div class="tab-pane" id="module_LBL_INVOICE_SETTING">
                    <div class="widgetContainer" style="padding: 20px 5px 5px 20px;">
                        <div class="row-fluid">
                            <span class="span2">
                                {'Invoice Billing: Active/Inactive?'}
                            </span>
                            <select name="allow_bill_event_invoice">
                                <option value="0" {if $ALLOW_BILL_EVENT_INVOICE eq 0}selected="selectde"{/if}>Inactive</option>
                                <option value="1" {if $ALLOW_BILL_EVENT_INVOICE eq 1}selected="selectde"{/if}>Active</option>
                            </select>
